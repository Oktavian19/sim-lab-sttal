<div class="relative w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="p-6 space-y-6">
        ...
        <div>
            ...
            <div rows="3"
                class="w-full rounded-md bg-gray-100 border-gray-300 shadow-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-3 border">{{  $peminjaman->catatan_admin ?? 'Tidak ada catatan' }}</textarea>
        </div>
    </div>
</div>
