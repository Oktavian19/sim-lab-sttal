<form action="{{ url($role . '/' . $user->id . '/update') }}" method="POST" id="form-edit" class="w-full validate">
    @csrf
    ...
    <div class="relative w-full max-w-2xl mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div class="px-6 py-4 space-y-4">
            ...
            <div>
                ...
                <p id="error-role" class="mt-1 text-sm text-red-600"></p>
            </div>
        </div>
