<form action="{{ url('alat/store') }}" method="POST" id="form-tambah" class="w-full validate">
    @csrf
    <div class="relative w-full max-w-2xl mx-auto bg-white rounded-lg shadow-lg">
        <div class="flex items-center justify-between px-6 py-4 border-b">
            <h5 class="text-lg font-semibold text-gray-800">Tambah Alat</h5>
                ...
                <select name="lokasi" id="lokasi"
                   ...
                   focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200">
                    ...
                    @foreach ($lab as $laboratorium)
                        <option value="{{ $laboratorium->id }}">{{ $laboratorium->nama_lab }}</option>
                    @endforeach
                </select>
